...
FLOOR_ROOMS = {
    ...
    # ═══ 2층 ═══
    2: [
        _r("체육관", "체육관", 60, 120, 500, 360, "special", fs=20),
        _r("예술체육부", "예술체육부", 610, 120, 115, 66, "office", fs=11),
        _r("Wee클래스", "Wee클래스", 610, 186, 115, 80, "office", fs=11),
        _r("계단C2", "계단", 625, 320, 75, 75, "facility"),
        _r("통합교육지원실", "통합교육\n지원실", 610, 425, 115, 105, "special", fs=12),
        _r("사물함2", "사물함", 760, 160, 115, 140, "facility", fs=12),
        _r("사이언스북클럽", "사이언스\n북클럽", 760, 350, 115, 215, "special", fs=12),
        _r("ELV2", "ELV", 805, 585, 70, 65, "facility"),
        _r("화장실남T2", "화장실\n(남)", 975, 230, 48, 70, "facility"),
        _r("화장실여T2", "화장실\n(여)", 1023, 230, 48, 70, "facility"),
        _r("108", "1-8", 1080, 160, 93, 140, "class"),
        _r("109", "1-9", 1173, 160, 93, 140, "class"),
        _r("110", "1-10", 1266, 160, 93, 140, "class"),
        _r("111", "1-11", 1359, 160, 93, 140, "class"),
        *_right_end(2),
...
FLOOR_CORRIDORS = {
    ...
    2: [
        (560, 120, 50, 590),               # 체육관 옆 세로 복도
        (725, 300, 727, 50, "복도"),        # 1-8~1-11 앞 복도
        (875, 350, 50, 360),               # 중앙 세로 복도
